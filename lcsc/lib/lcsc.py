...
def run_easyeda2kicad_from_file(input_file, output_dir="./lcsc", python_exec="python"):
...
def main(argv=None):
    ...
    parser.add_argument("output_dir", nargs="?", default="./lcsc_output", help="Output directory")
